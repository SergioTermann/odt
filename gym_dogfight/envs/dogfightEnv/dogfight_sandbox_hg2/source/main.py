...
import argparse
from network_server import set_init_port
p = argparse.ArgumentParser()
p.add_argument('--port', type=int, default=57805)
args = p.parse_args()
set_init_port(args.port)
...
# --------------- Compile assets:
print("nothing changed , do not compile assets")
# print("Compiling assets...")
#line 70-77 when you change sth in harfang, remenber to open.
