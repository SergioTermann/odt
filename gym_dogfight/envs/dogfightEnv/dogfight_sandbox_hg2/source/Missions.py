...
# ============================ Client / Server mode
	...
	def network_mode_setup(cls, main):
		...
		cls.setup_carriers(main.aircraft_carrier_allies, hg.Vec3(0, 0, 0), hg.Vec3(500, 0, 100), 0)
		cls.setup_carriers(main.aircraft_carrier_ennemies, hg.Vec3(-10500, 0, 0), hg.Vec3(500, 0, -150), radians(90))
		...
		if n == 1:
			...
			# cls.aircrafts_starts_in_sky(main.players_ennemies[0:n//2], hg.Vec3(-10600, 1000, 0), hg.Vec3(500, 500, 500), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))
			# cls.aircrafts_starts_in_sky(main.players_ennemies[n//2:n], hg.Vec3(-10400, 1000, 0), hg.Vec3(500, 500, 500), hg.Vec2(-0, 0), hg.Vec2(800 / 3.6, 600 / 3.6))
		elif n == 3:
