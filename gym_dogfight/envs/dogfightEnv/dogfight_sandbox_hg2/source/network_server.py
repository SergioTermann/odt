...
# port = [50888, 60886, 60887, 60863, 60864]
# def access_port(port):
...
# for i in port:
# 	if access_port(i):
# 		dogfight_network_port = i
# 		break
# main = None
dogfight_network_port = 50888
# dogfight_network_port = 57805
...
def set_init_port(port):
	global dogfight_network_port
	print('set port:', port)
	dogfight_network_port = port
...
def init_server(main_):
	...
	commands_functions = {
		...
		# Aircrafts
		"GET_PLANES_LIST": get_planes_list,
		...
		# Missiles
		"GET_MISSILES_LIST": get_missiles_list,
