...
class F16_Parameters:
    ...
    def __init__(self):
        ...
        # self.missiles_config = ["AIM_SL", "AIM_SL", "Karaoke", "Karaoke", "Karaoke", "Karaoke", "CFT", "CFT", "Mica","Mica","Mica","Mica"]
        self.missiles_config = ["Mica", "Mica", "Mica", "Mica", "Mica", "Mica", "Mica", "Mica", "Mica", "Mica", "Mica", "Mica"]
        # self.missiles_config = ["AIM_SL"]
